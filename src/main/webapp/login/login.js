CDNscope(function () {
    //全局接口,可配置
    var dark = {
        login: 'http://127.0.0.1:8080/adminLogin',
        findAll: 'http://127.0.0.1:8080/adm/findAll',
        register: 'http://127.0.0.1:8080/register',
        find: 'http://127.0.0.1:8080/sendForgetEmail',
        you: true,
        login_: {
    ...
    if (location.hash == "#login") {
        (function () {
            ...
            function render() {
                ...
                $(".layer.l2").show();
                $(".layer.l3").show();
                $(".layer.l1").html('<div class="DUYI_DIV DUYI_checkbox" style="float:left;" value="记住密码">记住密码</div><div class="DUYI_DIV find" style="float:right; cursor: pointer;">忘记密码</div>');
            ...
            // 绑定找回密码事件
            function blind_find() {
                var temp = document.querySelector(".DUYI_DIV.find");
                temp.onclick = function () {
                    location.href = './login.html#find';
                    location.reload();
                }
            }
            blind_find();
                    ...
                    if (validatorOk) {
                        ...
                        if (dark.you == false) {
                            ...
                            $.post(dark.login, postData, function (a, b, c) {
                                ...
                                if (a.status == "Success") {
                                    msgBox.show(document.body.offsetWidth / 2 - 200, document.body.offsetHeight / 2 - 100, "一个和蔼的警告：", "登录成功... ...客官别急，后面的页面还没写呢", 2, "");
                                } else {
                                    msgBox.show(document.body.offsetWidth / 2 - 200, document.body.offsetHeight / 2 - 100, "一个和蔼的警告：", a.msg, 2, "", msgBox.skin.errorTip);
                                }
                            });
                        }
                    }
        ...
        (function () {
            ...
            function render() {
                ...
                $(".layer.l1").hide();
                $(".layer.l2").show();
                $(".layer.l2").html('<div class="DUYI_button" style="float:right; width:100%">找回密码</div>');
                $(".layer.l3").hide();
            }
            render();
            ...
            function blind_find() {
                ...
                temp.onclick = function () {
                    ...
                    if (validatorOk) {
                        dark.find_.validatorSuccess(postData);
                        if (dark.you == false) {
                            // jsonp种cookie
                            $.ajax({
                                type: 'get',
                            ...
                            $.post(dark.find, postData, function (a, b, c) {
                                //成功
                                a = JSON.parse(a);
                                if (a.status == "Success") {
                                    msgBox.show(document.body.offsetWidth / 2 - 200, document.body.offsetHeight / 2 - 100, "一个和蔼的警告：", "邮件已经发送", 2, "");
                                } else {
                                    msgBox.show(document.body.offsetWidth / 2 - 200, document.body.offsetHeight / 2 - 100, "一个和蔼的警告：", a.msg, 2, "", msgBox.skin.errorTip);
                                }
    ...
    else if (location.hash == "#setPassword") {
        (function () {
            postData = {
                type: 'find',
                email: ''
                    ...
                    if (validatorOk) {
                        ...
                        if (dark.you == false) {
                            ...
                            $.post(dark.register, postData, function (a, b, c) {
                                ...
                                dark.register_.ajaxSuccess(a);
                                if (a.status == "Success") {
                                    msgBox.show(document.body.offsetWidth / 2 - 200, document.body.offsetHeight / 2 - 100, "一个和蔼的警告：", "注册成功... ...客官别急，后面的页面还没写呢", 2, "");
                                } else {
                                    msgBox.show(document.body.offsetWidth / 2 - 200, document.body.offsetHeight / 2 - 100, "一个和蔼的警告：", a.msg, 2, "", msgBox.skin.errorTip);
                                }
                            });
